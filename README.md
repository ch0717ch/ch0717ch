...
| 프로젝트 | 무엇인가 | 스택 |
| --- | --- | --- |
| **[fki-survey](https://github.com/ch0717ch/fki-survey)** | 인턴 때 교육 만족도조사를 받으며 만든 자체 설문 플랫폼. 구글폼 대신 쓰려고 모바일 응답 기준으로 설계했고, 관리자가 문항·보기를 직접 편집해 xlsx로 뽑습니다. | `JavaScript` `Cloudflare Pages` `Supabase` |
